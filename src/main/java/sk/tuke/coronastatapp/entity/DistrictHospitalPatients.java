...
public class DistrictHospitalPatients {
    ...
    public DistrictHospitalPatients(int id, Date oldestReportedAt, Date newestReportedAt, Date publishedOn, int districtId, int ventilatedCovid, int nonCovid, int confirmedCovid, int suspectedCovid, Date updatedAt) {
        this.id = id;
        this.oldestReportedAt = oldestReportedAt;
        this.newestReportedAt = newestReportedAt;
        this.publishedOn = publishedOn;
